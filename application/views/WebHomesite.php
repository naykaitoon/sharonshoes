        ...
        $("#contentDetial").load(heff);
  		 ...
  		 $('#toggle-event').change(function() {
			 ...
			 if($(this).prop('checked')==true){
				 ...
				 window.location.href = "<?php echo base_url();?>index.php/site/index/th";
				 
			 }else if($(this).prop('checked')==false){
				 			
				  window.location.href = "<?php echo base_url();?>index.php/site/index/en";
...
<!-- Mirrored from templates.mycookroom.ru/Vortex-v1.0.1/Site/ by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 28 Jun 2015 16:44:56 GMT -->
</html>