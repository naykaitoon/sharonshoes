...
<body>
			...
			<div >
				...
				<ul id="nav">
					...
					<li><i class="glyphicon glyphicon-envelope"></i><a href="#" title="<?php echo $contact;?>"<?php echo $contactsize+10?>> <?php echo $contact;?></a></li>
					 ...
					 <li><i class="glyphicon glyphicon-check"></i><a href="<?php echo base_url();?>index.php/site/page/login" class="register"   title="<?php echo $resgister;?>"<?php echo $resgistersize+10?>> <?php echo $resgister;?></a></li>
  ...
  <?php if($faLoginStatus=="no"){?>
     ...
     <?php if($faLoginStatus=="no"){?>
					 <li><a href="<?php echo base_url();?>index.php/site/page/login" class="register"   title="<?php echo $resgister;?>"<?php echo $resgistersize?>><i class="glyphicon glyphicon-check"></i> <?php echo $resgister;?></a></li>
