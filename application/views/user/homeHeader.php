	...
	<div id="overlay-menu" class="overlay-menu">
		...
		<div class="overlay-menu-inner">
			...
			<div >
				...
				<ul id="nav">
					<li><i class="glyphicon glyphicon-home"></i><a href="<?php echo base_url();?>index.php/user" title="<?php echo $homeMenu;?>" <?php echo $homeMenusize+10?>> <?php echo $homeMenu;?></a></li>
					<li><i class="glyphicon glyphicon-folder-close"></i><a onClick="scool();" href="<?php echo base_url();?>index.php/user#portfolio" title="<?php echo $product;?>"<?php echo $productsize+10?>> <?php echo $product;?></a></li>
		...
		<nav class="navbar navbar-custom navbar-transparent navbar-light navbar-fixed-top">
			...
			<div class="container">
				...
				<!-- /ICONS NAVBAR -->
                 ...
                 <li id="swichee">
                  ...
                  <?php if($select == "th"){ echo "checked";}?> data-toggle="toggle" data-style="android" data-onstyle="info" data-on="th" data-off="en"   data-size="mini" id="toggle-event" type="checkbox"></a>
					   ...
					   <li><a href="<?php echo base_url();?>index.php/user/getAllBuy" id="allBuy" data-toggle="modal" data-target="#allBuyss" <?php echo $resgistersize+10?>><i style="font-size:2em;color:#000;"  class="glyphicon glyphicon-shopping-cart"></i><b id="notti">0</b></a></li>       
                                  

                   
           	  
                    <li  class="dropdown" ><a id="proFi" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true" href="#" class="profile"    title="profile"<?php echo $resgistersize?>>
                    <img style="width:30px;height:30px;border-radius:100%;margin-top:-5px;" <?php if($user){?> src="https://graph.facebook.com/<?php echo $user; ?>/picture" <?php }else{?> src="<?php echo base_url();?>img/unknownuser.jpg" <?php }?>></a>
				...
				<ul class="extra-navbar nav navbar-nav navbar-right" style="margin-left:-10px;">
					...
					<li><a href="<?php echo base_url();?>index.php/user" title="<?php echo $homeMenu;?>" <?php echo $homeMenusize?>><i class="glyphicon glyphicon-home"></i> <?php echo $homeMenu;?></a></li>
					<li><a onClick="scool();" href="<?php echo base_url();?>index.php/user#portfolio" title="<?php echo $product;?>"<?php echo $productsize?>><i class="glyphicon glyphicon-folder-close"></i> <?php echo $product;?></a></li>
